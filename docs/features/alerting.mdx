...
You can view a consolidated history of all alerts across all of your monitored Virtual Machines using the Global Notification Bell located in the top navigation bar of the application.

- Click the **Bell Icon** on the navbar to open the dropdown.
- Shows all recent alerts across your VMs (connectivity drops, recoveries, and metrics failures).
- Click on any notification to directly navigate to the affected Virtual Machine's dashboard.
- Red badge indicator shows when you have unread notifications.
