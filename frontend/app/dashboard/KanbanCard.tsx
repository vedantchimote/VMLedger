  ...
  return (
    <div className="glass-card p-4 group border border-transparent hover:border-white/10 transition-colors">
      ...
      <div className="flex gap-2 mt-2">
        ...
        <button onClick={() => router.push(`/vms/${vm.id}`)} className="flex-1 py-1.5 bg-brand-500/10 hover:bg-brand-500/20 text-brand-400 hover:text-brand-300 rounded-lg transition-colors text-[10px] font-bold uppercase tracking-wider border border-brand-500/20 text-center">
          Metrics
        </button>
      </div>
    </div>
