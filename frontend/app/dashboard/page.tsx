                  ...
                  >
                    ...
                    <div className="px-6 py-4 flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Link href={`/vms/${vm.id}/terminal`} target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white rounded-lg transition-colors text-[10px] font-bold uppercase tracking-wider border border-white/5 flex items-center gap-1.5" title="Quick Connect (SSH)">
                ...
                {displayVms.map((vm: VM, idx) => (
                  <div key={vm.id} className="glass-card group flex flex-col md:flex-row items-center p-4 gap-6" style={{ animationDelay: `${idx * 50}ms` }}>
                    ...
                    <div className="flex items-center gap-2">
                      <Link href={`/vms/${vm.id}/terminal`} target="_blank" rel="noopener noreferrer" className="px-3 py-1 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white rounded-lg transition-colors text-[10px] font-bold uppercase tracking-wider border border-white/5 flex items-center gap-1" title="Quick Connect (SSH)">
                ...
                {displayVms.map((vm) => (
                  <div key={vm.id} className="flex items-center justify-between p-3 px-4 glass-panel rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/10 group">
                    ...
                    <div className="flex items-center gap-3 opacity-50 group-hover:opacity-100 transition-opacity">
                      <button onClick={(e) => { e.stopPropagation(); window.open(`/vms/${vm.id}/terminal`, '_blank'); }} className="px-3 py-1 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white rounded-lg transition-colors text-[10px] font-bold uppercase tracking-wider border border-white/5 flex items-center gap-1" title="Quick Connect (SSH)">
                        <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                      </button>
